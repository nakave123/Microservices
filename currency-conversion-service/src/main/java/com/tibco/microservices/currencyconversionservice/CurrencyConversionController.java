...
public class CurrencyConversionController {
	...
	CurrencyConversion calculateCurrencyConversionFeign(
			@PathVariable(value="from") String from, @PathVariable(value="to") String to, @PathVariable BigDecimal quantity) {
		
		CurrencyConversion currencyConversion = proxy.retreiveExchageValue(from, to);
